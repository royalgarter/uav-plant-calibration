...
case "$1" in
    ...
    "build:calib-webui-win")
        ...
        ;;
    "build:calib-win-gui")
        run_cmd $CC $CFLAGS src/calib.cc src/calib-func.cc -o window_build/calib-wingui.exe $LIBS $TIFFLIB_WIN $OPENCVLIB_WIN $RAYLIB $WINGUILIB
    ...
    "webui")
        run_cmd env $LD_LINUX npm start
        ;;
    ...
    "build:fisheye")
        run_cmd $CC $CFLAGS src/cli.cc -o fisheye $OPENCVLIB $LIBS
        ;;
    "build:fisheye-win")
